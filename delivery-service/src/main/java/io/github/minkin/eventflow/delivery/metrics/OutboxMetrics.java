package io.github.minkin.eventflow.delivery.metrics;
...
public class OutboxMetrics {
  ...
  public OutboxMetrics(JdbcClient jdbc, MeterRegistry meters) {
    ...
    meters.gauge(
        ...
        java.util.List.of(io.micrometer.core.instrument.Tag.of("service", "delivery")),
        this,
        value -> value.pending);
    meters.gauge(
  ...
  public void refresh() {
    var values =
        jdbc.sql(
                ...
                FROM delivery_outbox WHERE published_at IS NULL
                """)
            .query()
            .singleRow();
