package io.github.minkin.eventflow.processing.metrics;
...
public class OutboxMetrics {
  ...
  public OutboxMetrics(JdbcClient jdbc, MeterRegistry meters) {
    ...
    meters.gauge(
        ...
        java.util.List.of(io.micrometer.core.instrument.Tag.of("service", "processing")),
        this,
        value -> value.pending);
    meters.gauge(
  ...
  public void refresh() {
    var values =
        jdbc.sql(
                ...
                FROM processing_outbox WHERE published_at IS NULL
                """)
            .query()
            .singleRow();
